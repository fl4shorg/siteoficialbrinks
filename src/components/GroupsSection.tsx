...
const GroupCard: React.FC<{ group: Group }> = ({ group }) => {
  ...
  return (
    <div className="relative group cursor-pointer card-elevated bg-card rounded-lg overflow-hidden backdrop-blur-sm hover:border-brinks-blue/30 transition-all duration-500 h-full w-full">
      ...
      <div 
        className="relative h-28 sm:h-32 md:h-36 w-full bg-cover bg-center overflow-hidden rounded-t-lg"
      ...
      <div className="relative bg-gradient-to-b from-card to-muted/30 p-1.5 sm:p-2 space-y-1 sm:space-y-1.5 rounded-b-lg">
        ...
        <h3 className="text-[10px] sm:text-xs font-bold bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent leading-tight line-clamp-2">
          {group.name}
        </h3>
      ...
      <section id="grupos" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-background to-muted/30 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-1/4 left-1/4 animate-bounce">
            <div className="w-4 h-4 bg-gradient-to-br from-brinks-blue to-brinks-green transform rotate-45 opacity-30"></div>
          </div>
          <div className="absolute top-1/3 right-1/4 animate-bounce">
            <div className="w-3 h-3 bg-gradient-to-br from-yellow-400 to-amber-500 transform rotate-45 opacity-40"></div>
          </div>
          <div className="absolute bottom-1/3 left-1/3 animate-bounce">
            <div className="w-5 h-5 bg-gradient-to-br from-brinks-green to-emerald-400 transform rotate-45 opacity-25"></div>
          </div>
          <div className="absolute bottom-1/4 right-1/3 animate-bounce">
            <div className="w-3 h-3 bg-gradient-to-br from-purple-400 to-violet-500 transform rotate-45 opacity-30"></div>
          </div>
        </div>

        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center py-20">
            {/* Roman temple-inspired loading design */}
            <div className="relative mx-auto mb-8 w-32 h-20">
              {/* Temple base */}
              <div className="absolute bottom-0 w-full h-2 bg-gradient-to-r from-brinks-blue/30 to-brinks-green/30 rounded-sm"></div>
              
              {/* Columns with animated diamonds */}
              <div className="absolute bottom-2 left-4 w-2 h-16 bg-gradient-to-t from-muted to-muted/50 rounded-t-sm"></div>
              <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 w-2 h-16 bg-gradient-to-t from-muted to-muted/50 rounded-t-sm"></div>
              <div className="absolute bottom-2 right-4 w-2 h-16 bg-gradient-to-t from-muted to-muted/50 rounded-t-sm"></div>
              
              {/* Animated diamond on top */}
              <div className="absolute -top-2 left-1/2 transform -translate-x-1/2">
                <div className="w-6 h-6 bg-gradient-to-br from-brinks-blue via-purple-400 to-brinks-green transform rotate-45 animate-pulse shadow-lg"></div>
                <div className="absolute inset-0 w-6 h-6 bg-gradient-to-tr from-yellow-200 to-transparent transform rotate-45 animate-ping"></div>
              </div>
              
              {/* Floating mini diamonds around */}
              <div className="absolute -top-1 left-2 animate-pulse delay-100">
                <div className="w-2 h-2 bg-gradient-to-br from-yellow-400 to-amber-500 transform rotate-45 opacity-60"></div>
              </div>
              <div className="absolute -top-1 right-2 animate-pulse delay-200">
                <div className="w-2 h-2 bg-gradient-to-br from-emerald-400 to-green-500 transform rotate-45 opacity-60"></div>
              </div>
            </div>

            {/* Elegant Roman-style text */}
            <div className="space-y-2">
              <h3 className="text-lg sm:text-xl font-bold bg-gradient-to-r from-brinks-blue via-purple-500 to-brinks-green bg-clip-text text-transparent">
                ⚔️ BRINKS IMPERIUM ⚔️
              </h3>
              <p className="text-sm sm:text-base text-muted-foreground font-medium">
                Convocando as Legiões...
              </p>
              <p className="text-xs text-muted-foreground/70 mt-1">
                Carregando grupos
              </p>
              <div className="flex items-center justify-center gap-1 mt-4">
                <div className="w-2 h-2 bg-brinks-blue rounded-full animate-bounce"></div>
                <div className="w-2 h-2 bg-purple-400 rounded-full animate-bounce delay-100"></div>
                <div className="w-2 h-2 bg-brinks-green rounded-full animate-bounce delay-200"></div>
              </div>
            </div>

            {/* Roman ornamental border */}
            <div className="mt-8 flex items-center justify-center">
              <div className="w-16 h-px bg-gradient-to-r from-transparent via-brinks-blue to-transparent"></div>
              <div className="mx-4 w-3 h-3 bg-gradient-to-br from-yellow-400 to-amber-500 transform rotate-45"></div>
              <div className="w-16 h-px bg-gradient-to-r from-transparent via-brinks-green to-transparent"></div>
            </div>
          </div>
        </div>
      </section>
